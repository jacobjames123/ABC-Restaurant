...
import RoomResult from "../common/TableResult";
import RoomSearch from "../common/TableSearch";
...
const HomePage = () => {
    ...
    return (
        <div className="home">
            ...
            <section>
                <header className="header-banner">
                    ...
                    <div className="animated-texts overlay-content">
                        <h1>
                            Welcome to <span className="phegon-color">ABC Restaurant</span>
                        </h1><br />
                        <h3>Step into a exquisite food style and luxury halls</h3>
                    </div>
                </header>
            </section>
            ...
            <h4><a className="view-rooms-home" href="/rooms">All Table reseravtion</a></h4>

            <h2 className="home-services">Services at <span className="phegon-color">ABC Restaurant</span></h2>

            {/* SERVICES SECTION */}
            <section className="service-section"><div className="service-card">
                <img src="./assets/images/musical-note.png" alt="Air Conditioning" />
                ...
                <div className="service-card">
                    <img src="./assets/images/swimming.png" alt="Mini Bar" />
                    <div className="service-details">
                ...
                <div className="service-card">
                    <img src="./assets/images/valet.png" alt="Parking" />
                    <div className="service-details">
                        <h3 className="service-title">Valet Services</h3>
